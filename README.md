...
This is the Wolt Assignement for Summer 23.([More details](./Wolt_Assignement.md))

## Task Description
Your task is to build an HTTP API which could be used for calculating the delivery fee and build a delivery fee calculator web app.
